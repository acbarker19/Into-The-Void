...
/////////////////////////////////////////////////////////////////////
//start class
function MathAddBox(name, age, theOver, theDown)
{
	...
	var _clickAreaWidth = 0;		//_size; 
	var _clickAreaHeight = 0;		//_size;
	...
	this.draw = function draw(context)
		{
		    ...
		    var centerX = this.over + _size / 2;
      		...
      		//draw the plus sign
      		context.moveTo(this.over,this.down-signOffset);
      		context.lineTo(this.over+signLength,this.down-signOffset);
      		
      		context.moveTo(this.over+signLength/2,this.down-signOffset-signLength/2);
      		context.lineTo(this.over+signLength/2,this.down-signOffset+signLength/2);
      		
      		//now draw the main line
      		context.moveTo(this.over,this.down);
      		context.lineTo(this.over+80,this.down);
      		//context.fill();
      		context.stroke();
