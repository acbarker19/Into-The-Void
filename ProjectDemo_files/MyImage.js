...
/////////////////////////////////////////////////////////////////////
//start class
function MyImage(name, age, theOver, theDown)
{
	...
	this.draw = function draw(context)
	{
		...
		if (this.isVisible == true)
		{
			...
			*/
			...
			//display the image
			img = document.getElementById(_name);
			context.drawImage(img, this.over, this.down,100,100);  //draw img at _g_turkeyOver, 50 with size 100 px x 100 px
