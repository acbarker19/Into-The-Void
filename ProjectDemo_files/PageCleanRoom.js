...
*/
function PageCleanRoom(pageName, animationList, optionList)
{
		...
		if (this.userSelectedObject != null)
		{
			...
			if (nameOfLastObject == "Basket")
			{
				if (lastObject.hitTest(point))
				{
					...
					this.userSelectedObject.isVisible = false;
					_numItemsDropped++;
					if (_numItemsDropped == 3)
					{
			
				
						alert("You put three clothing items in the basket!");
